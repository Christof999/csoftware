    ...
    <section className="border-b border-gallery-line bg-gallery-bg py-20 sm:py-24">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Ein Klick zeigt mehr — Screenshots und kurze Beschreibung zu jedem
            Projekt.
          </motion.p>
        </motion.div>
            ...
            return (
              <motion.li key={project.slug} custom={i} variants={fadeInUp}>
                <Link
                  ...
                  className="group block overflow-hidden rounded-2xl border border-gallery-line bg-gallery-surface shadow-card transition hover:border-stone-300 hover:shadow-soft"
                >
                  ...
                  <div className="flex items-start justify-between gap-4 border-t border-gallery-line p-5">
                    <div>
                    ...
                    <span className="mt-1 shrink-0 text-stone-400 transition group-hover:text-gallery-ink">
