  ...
  return (
    <article className="pb-24 pt-12">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <Link
          to="/arbeiten"
          className="inline-flex items-center gap-2 text-sm text-stone-600 transition hover:text-gallery-ink"
        >
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        variants={staggerContainer}
        className="mx-auto mt-14 max-w-5xl px-4 sm:px-6 lg:px-8"
      >
        <ul className="grid gap-6 sm:grid-cols-2">
          {project.screenshots.map((file, i) => (
            <motion.li
              ...
              custom={i}
              variants={fadeInUp}
              className="overflow-hidden rounded-xl border border-gallery-line bg-gallery-surface shadow-card"
            >
              ...
              <p className="border-t border-gallery-line px-3 py-2 text-xs text-stone-500">
                {file}
              </p>
            </motion.li>
          ))}
